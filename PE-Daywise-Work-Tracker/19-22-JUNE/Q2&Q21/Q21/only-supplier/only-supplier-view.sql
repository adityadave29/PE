...
DROP VIEW IF EXISTS orders_secure CASCADE;
DROP VIEW IF EXISTS customer_secure CASCADE;
DROP VIEW IF EXISTS part_secure CASCADE;
DROP VIEW IF EXISTS partsupp_secure CASCADE;
DROP VIEW IF EXISTS nation_secure CASCADE;
DROP VIEW IF EXISTS region_secure CASCADE;

-- ============================================================
-- STEP 4: Create equivalent supplier view
-- ============================================================
